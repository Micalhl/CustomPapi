...
public class SetCommand extends BaseCommand {
    ...
    protected void call(String[] strings) {
        ParamUtil.set(convert(1, strings, String.class), convert(0, strings, OfflinePlayer.class).getUniqueId(), convert(2, strings, Double.class));
        sender.sendMessage(info("已成功为玩家 &c{0} &f的 &c{1} &f变量设定了数值 &c{2}&f.", convert(0, strings, OfflinePlayer.class).getName(), convert(1, strings, String.class), convert(2, strings, Double.class)));
    }
}
